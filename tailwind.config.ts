	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				lightOn: 'hsl(var(--light-on))',
				lightOff: 'hsl(var(--light-off))',
				destructive: {
			...
			keyframes: {
				...
				'glow-pulse': {
					'0%, 100%': { 
						boxShadow: '0 0 20px rgba(56, 189, 248, 0.4), 0 0 40px rgba(56, 189, 248, 0.2)' 
					},
					'50%': { 
			...
			animation: {
				...
				'bounce-light': 'bounce-light 0.3s ease-in-out',
